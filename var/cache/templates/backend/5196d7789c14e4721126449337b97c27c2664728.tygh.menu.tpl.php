<?php /* Smarty version Smarty-3.1.21, created on 2021-12-22 17:11:16
         compiled from "C:\OpenServer\domains\cscart2\design\backend\templates\menu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:152369993561c33204bcb152-39021634%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5196d7789c14e4721126449337b97c27c2664728' => 
    array (
      0 => 'C:\\OpenServer\\domains\\cscart2\\design\\backend\\templates\\menu.tpl',
      1 => 1639041538,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '152369993561c33204bcb152-39021634',
  'function' => 
  array (
    'menu_attrs' => 
    array (
  ...
  'unifunc' => 'content_61c33204e672a1_14315232',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_61c33204e672a1_14315232')) {function content_61c33204e672a1_14315232($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/OpenServer/domains/cscart2/app/functions/smarty_plugins\\block.hook.php';
if (!is_callable('smarty_modifier_sizeof')) include 'C:/OpenServer/domains/cscart2/app/functions/smarty_plugins\\modifier.sizeof.php';
if (!is_callable('smarty_function_include_ext')) include 'C:/OpenServer/domains/cscart2/app/functions/smarty_plugins\\function.include_ext.php';
if (!is_callable('smarty_modifier_enum')) include 'C:/OpenServer/domains/cscart2/app/functions/smarty_plugins\\modifier.enum.php';
if (!is_callable('smarty_modifier_truncate')) include 'C:/OpenServer/domains/cscart2/app/functions/smarty_plugins\\modifier.truncate.php';
?><?php
...
$_tmp16=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['storefront_url'] = new Smarty_variable(fn_url("profiles.act_as_user?user_id=".((string)$_smarty_tpl->tpl_vars['auth']->value['user_id'])."&area=C".$_tmp16), null, 0);?>
                            <?php } else { ?>
                                <?php ob_start();
if ($_smarty_tpl->tpl_vars['storefront_id']->value) {?><?php echo "&storefront_id=";?><?php echo (string)$_smarty_tpl->tpl_vars['storefront_id']->value;?><?php }
$_tmp17=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['storefront_url'] = new Smarty_variable($_smarty_tpl->tpl_vars['runtime']->value['company_id'] ? "companies.products?company_id=".((string)$_smarty_tpl->tpl_vars['runtime']->value['company_id']).$_tmp17 : '', null, 0);?>
