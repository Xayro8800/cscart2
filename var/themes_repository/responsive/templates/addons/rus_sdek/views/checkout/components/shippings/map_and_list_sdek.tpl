...
{$sdek_map_container = "sdek_map_container_`$shipping.shipping_id`_`$shipping.group_key`"}
...
<div class="ty-checkout-select-store__map-full-div pickup pickup--map-list">
    ...
    <div class="ty-checkout-select-store__map pickup__map-wrapper">
        <div class="pickup__map-container cm-geo-map-container" id="{$sdek_map_container}"
             ...
             data-ca-geo-map-marker-selector=".cm-rus-sdek-map-marker-{$shipping.shipping_id}-{$shipping.group_key}"
        ></div>
    ...
    {foreach from=$shipping.data.offices item=store}
        ...
        <div class="cm-rus-sdek-map-marker-{$shipping.shipping_id}-{$shipping.group_key} hidden"
